    ...
    theme: {
        ...
        extend: {
            ...
            boxShadow: {
                ...
                'glow-red': '0 0 20px rgba(213, 0, 0, 0.3)',
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
                ...
                'pulse-critical': {
                    '0%, 100%': { opacity: '1', boxShadow: '0 0 0 0 rgba(213, 0, 0, 0.7)' },
                    '50%': { opacity: '0.8', boxShadow: '0 0 0 8px rgba(213, 0, 0, 0)' }
                },
                'pulse-live': {
                    '0%, 100%': { opacity: '1', boxShadow: '0 0 0 0 rgba(0, 200, 83, 0.7)' },
                    '50%': { opacity: '0.8', boxShadow: '0 0 0 6px rgba(0, 200, 83, 0)' }
                }
            },
            animation: {
